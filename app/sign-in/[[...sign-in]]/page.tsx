  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-zinc-950 font-sans text-zinc-100">
      ...
      <div className="flex min-h-screen flex-col lg:flex-row">
        <div className="relative hidden flex-col items-center justify-center overflow-hidden border-r border-white/10 bg-zinc-950 p-12 lg:flex lg:w-1/2">
          ...
          >
            ...
            >
              Your recordings,
              <br />
              <span className="text-primary">ready as text.</span>
            </motion.h2>
            ...
            >
              Access your AI-generated transcripts, refine your content, and
              keep moving forward.
            </motion.p>
          </motion.div>
        ...
        <div className="relative flex min-h-screen flex-1 items-center justify-center bg-zinc-950 px-6 sm:px-8 lg:min-h-0 lg:w-1/2 lg:px-12">
          ...
          >
            ...
            >
              ...
              <p className="text-[17px] text-zinc-400">
                Sign in to access your transcripts and recordings.
              </p>
            </motion.div>

            <motion.div variants={rightItem} className="w-full px-1">
              <SignIn
                appearance={{
                  elements: {
                    rootBox: "w-full",
